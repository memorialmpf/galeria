          ...
          <div class="col-9">
            <div class="row">
              ...
              <div class="col">
                ...
                <!-- COLUNA FOTO GRANDE -->
                <div class="col-5">
                  <img class="img-fluid rounded-circle mb-4" src="img/membro-big.png" width="450" height="450" alt="">
                  <p class="mt-2"><a class="btn" data-toggle="modal" data-target="#exampleModalCenter"><img src="img/btn-assista-video.png" alt=""></a></p>
                </div>

                <!-- COLUNA CURRICULO -->
                <div class="col-7 text-left" style="overflow-y:scroll; height: 44.5em;">
                  <h5 class="titulo-biografia">NOME</h5>
                  <h5>Aristides Junqueira Alvarenga</h5>

                  <h5 class="titulo-biografia">PERÍODO</h5>
                  <p>28/06/1989 a 28/06/1995</p>
